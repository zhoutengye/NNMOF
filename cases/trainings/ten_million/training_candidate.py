...
model = model_1()
his1 = model.fit(inputs,outputs,epochs=num_epoch,batch_size=n_batch_size,shuffle=False)
model.save('very_deep.h5')
with open('very_deep.json', 'w') as f:
    json.dump(hisq.history,f)

model = model_2()
his2 = model.fit(inputs,outputs,epochs=num_epoch,batch_size=n_batch_size,shuffle=False)
model.save('intermediate_deep.h5')
with open('intermediate.json', 'w') as f:
    json.dump(hisq.history,f)

model = model_3()
his3 = model.fit(inputs,outputs,epochs=num_epoch,batch_size=n_batch_size,shuffle=False)
model.save('fast.h5')
with open('fast.json', 'w') as f:
    json.dump(hisq.history,f)

model = model_4()
his4 = model.fit(inputs,outputs,epochs=num_epoch,batch_size=n_batch_size,shuffle=False)
