...
Subroutine compare
  ...
  delta_theta_max = 0.5_sp * MOF_Pi / 180.0_sp  ! 10 degrees
...
Subroutine onemethod(method, num_sampling, data_in, norm_out, times, iter, error)
  ...
  Do i = 1, num_sampling
    ...
    angle_error = angle_error + sum(abs(angle_out(:,i)-angle_analytic))
  End Do

  error = error / dble(num_sampling)
  c_error = c_error / dble(num_sampling)
  angle_error = angle_error / dble(num_sampling)
  ...
  Write(10,*)  'angle_error:', angle_error
