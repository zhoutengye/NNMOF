...
from backwardc import floodsz_backwardc, angle2norm, normalization1,normalization2
...
for i in range(10):
    tn = i+1
    pred = model.predict(inputs[tn-1:tn,:])
...
#    print('')
#    print(pred)
#    print(initial_angle[tn-1,:])
#    print(exact_angle[tn-1,:])
#    print(exact_norm)
    if np.linalg.norm(dce1,2) < np.linalg.norm(dce2,2):
        nn = nn +1
